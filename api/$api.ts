  ...
  return {
        ...
        return {
          uploadImage: {
            ...
            post: (option: { body: Methods_1k0b4d['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1k0b4d['post']['resBody'], BasicHeaders, Methods_1k0b4d['post']['status']>(prefix, `${prefix1}${PATH1}`, POST, option, 'FormData').json(),
            /**
             * @returns successful operation
             */
            $post: (option: { body: Methods_1k0b4d['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1k0b4d['post']['resBody'], BasicHeaders, Methods_1k0b4d['post']['status']>(prefix, `${prefix1}${PATH1}`, POST, option, 'FormData').json().then(r => r.body),
    ...
    store: {
      inventory: {
         ...
         */
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_gp223s['get']['resBody'], BasicHeaders, Methods_gp223s['get']['status']>(prefix, PATH3, GET, option).json(),
        /**
         * Returns a map of status codes to quantities
         * @returns successful operation
         */
        $get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_gp223s['get']['resBody'], BasicHeaders, Methods_gp223s['get']['status']>(prefix, PATH3, GET, option).json().then(r => r.body),
        $path: () => `${prefix}${PATH3}`,
      },
      order: {
        ...
        post: (option: { body: Methods_fgwm1g['post']['reqBody'], config?: T | undefined }) =>
          fetch<Methods_fgwm1g['post']['resBody'], BasicHeaders, Methods_fgwm1g['post']['status']>(prefix, PATH4, POST, option).json(),
        /**
         * @param option.body - order placed for purchasing the pet
         * @returns successful operation
         */
        $post: (option: { body: Methods_fgwm1g['post']['reqBody'], config?: T | undefined }) =>
          fetch<Methods_fgwm1g['post']['resBody'], BasicHeaders, Methods_fgwm1g['post']['status']>(prefix, PATH4, POST, option).json().then(r => r.body),
        $path: () => `${prefix}${PATH4}`,
      },
    },
    user: {
